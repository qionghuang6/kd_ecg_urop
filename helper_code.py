...
def get_labels(header):
    ...
    tier_1_dx = [429622005, 164931005, 704997005, 57054005, 413444003, 426434006, 54329005, 413844008, 425419005, 425623009, 164865005, 164861001, 164867002]
    ...
    tier_labels = []
    for tier_dxs, tier_string in zip([tier_1_dx, tier_2_dx, tier_3_dx], ['tier1', 'tier2', 'tier3']):
